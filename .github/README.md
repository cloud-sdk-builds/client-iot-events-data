...
[`@aws-sdk/client-iot-events-data`](https://www.npmjs.com/package/@aws-sdk/client-iot-events-data/v/3.946.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iot-events-data@3.946.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9+hKz5LAlxCCmF1434PbqH/miveDYZp79PPhNShWlzCG+XGVSq1eCa07fVfIXMgC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iot-events-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iot-events-data@3.946.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iot-events-data@3.946.0/index.min.mjs": "sha384-9+hKz5LAlxCCmF1434PbqH/miveDYZp79PPhNShWlzCG+XGVSq1eCa07fVfIXMgC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-iot-events-data/blob/refs/tags/3.946.0/LICENSE
```
